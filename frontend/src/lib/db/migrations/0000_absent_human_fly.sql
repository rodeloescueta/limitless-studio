...
CREATE INDEX "content_cards_team_idx" ON "content_cards" USING btree ("team_id");--> statement-breakpoint
CREATE INDEX "content_cards_stage_idx" ON "content_cards" USING btree ("stage_id");--> statement-breakpoint
...
CREATE INDEX "content_cards_stage_position_idx" ON "content_cards" USING btree ("stage_id","position");--> statement-breakpoint
CREATE INDEX "stages_team_position_idx" ON "stages" USING btree ("team_id","position");--> statement-breakpoint
